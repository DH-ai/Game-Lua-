...
function scene:create( event )
	...
	local copyryt = display.newText(sceneGroup,"Created by Dhruv Chaturvedi",display.contentCenterX,1000,native.systemFontBold,22)
	copyryt:setFillColor( 0.82, 0.86, 1 )
